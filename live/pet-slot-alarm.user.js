...
(function () {
  ...
  })("pet-slot-alarm", "4.12.0", function (Core) {
  ...
  function render() {
    ...
    if (ui.silenceBtn) {
      ...
      setAttr(ui.silenceBtn, 'class', 'awoo-ui-btn' + (silenced ? ' awoo-ui-btn-primary' : ''));
    }
    renderReadiness();
    renderProjection();
    ...
    setAttr(ui.startBtn, 'class', 'awoo-ui-btn' + (running ? ' awoo-pet-slot-alarm-dim' : ' awoo-ui-btn-primary'));
    setAttr(ui.stopBtn, 'class', 'awoo-ui-btn' + (running ? '' : ' awoo-pet-slot-alarm-dim'));
    ...
    setAttr(ui.resetBtn, 'class', 'awoo-ui-btn' + (resetUseful ? '' : ' awoo-pet-slot-alarm-dim'));
    ...
    if (trackerEtaMs === null) {
      ...
      if (ui.alarmHeadline.style.color !== 'var(--awoo-success)') ui.alarmHeadline.style.color = 'var(--awoo-success)';
  ...
  function renderReadiness() {
    ...
    setAttr(ui.readiness, 'class', 'awoo-pet-slot-alarm-notice awoo-pet-slot-alarm-notice-' + r.level);
    ui.readiness.innerHTML = '';
    const g = document.createElement('span');
    g.className = 'awoo-pet-slot-alarm-notice-g';
...
// ---- overlay UI ----
  ...
  function buildPanelContent() {
    ...
    style.textContent = `
      #awoo-pet-slot-alarm-header-party { font-size: var(--awoo-fs-control); opacity: var(--awoo-em-normal);
      ...
      #awoo-pet-slot-alarm-alarm-headline { font-weight: bold; font-size: var(--awoo-fs-title); }
      #awoo-pet-slot-alarm-alarm-sub { opacity: var(--awoo-em-normal); }
      ...
      .awoo-pet-slot-alarm-notice { font-size: var(--awoo-fs-control); line-height: 1.45;
        border: 1px solid transparent; border-radius: var(--awoo-r-sm);
        padding: var(--awoo-s3) var(--awoo-s4); display: flex; gap: var(--awoo-s3);
        align-items: flex-start; }
      .awoo-pet-slot-alarm-notice-ok { color: var(--awoo-success); opacity: var(--awoo-em-normal);
        border-color: color-mix(in srgb, var(--awoo-success) 35%, var(--awoo-border, var(--border))); }
      .awoo-pet-slot-alarm-notice-warn { color: var(--awoo-warn);
        border-color: color-mix(in srgb, var(--awoo-warn) 45%, var(--awoo-border, var(--border))); }
      .awoo-pet-slot-alarm-notice-g { flex: none; font-weight: 700; }
    `;
    ...
    content.innerHTML = `
        <span id="awoo-pet-slot-alarm-header-party" class="awoo-pet-slot-alarm-header-party"></span>
        <div id="awoo-pet-slot-alarm-hero" class="awoo-ui-answer">
          <div id="awoo-pet-slot-alarm-hero-actions" class="awoo-ui-answer-value">OFF</div>
          <div id="awoo-pet-slot-alarm-hero-label" class="awoo-ui-answer-sub">press Start to begin</div>
          <div id="awoo-pet-slot-alarm-hero-time" class="awoo-ui-answer-sub awoo-num"></div>
          <div id="awoo-pet-slot-alarm-alarm-headline">Idle</div>
          <div id="awoo-pet-slot-alarm-alarm-sub" class="awoo-pet-slot-alarm-hint-inline">-</div>
        </div>
        <div class="awoo-pet-slot-alarm-buttons">
          ...
          <button id="awoo-pet-slot-alarm-reset" class="awoo-ui-btn" type="button">Reset</button>
        </div>

        <div id="awoo-pet-slot-alarm-readiness" class="awoo-pet-slot-alarm-notice" hidden></div>
        ...
        <div class="awoo-ui-group">
          <div class="awoo-ui-group-label">Read</div>
          <div class="awoo-ui-rows">
            <span class="k">Slot</span>
            <span class="v" id="awoo-pet-slot-alarm-detail-level" data-tooltip="Your combat pet slot now, and the level it is saving toward.">-</span><span class="t"></span>
            <span class="k">Gold</span>
            <span class="v" data-tooltip="Gold you hold, against what the next slot upgrade costs." data-tooltip-wide><span id="awoo-pet-slot-alarm-detail-gold">-</span>
              <span id="awoo-pet-slot-alarm-detail-gold-source" class="awoo-pet-slot-alarm-hint-inline"></span></span><span class="t"></span>
            <span class="k">Rate</span>
            <span class="v" data-tooltip="Gold per action, measured from your Party Battle page." data-tooltip-wide><span id="awoo-pet-slot-alarm-detail-rate">-</span>
              <span id="awoo-pet-slot-alarm-detail-rate-source" class="awoo-pet-slot-alarm-hint-inline"></span></span><span class="t"></span>
            <span class="k">Pets page</span>
            <span class="v" id="awoo-pet-slot-alarm-detail-synced" data-tooltip="When your Pets page was last read. The rate above carries its own age." data-tooltip-wide>never</span><span class="t"></span>
          </div>
        </div>

        <div class="awoo-ui-group">
          <div class="awoo-ui-group-label">Party gold estimate</div>
          <div class="awoo-ui-rows">
            <span class="k">At pace</span>
            <span class="v" id="awoo-pet-slot-alarm-proj-flat" data-tooltip="Remaining actions at your current rate. No upgrades, no compounding." data-tooltip-wide>-</span><span class="t"></span>
            <span class="k">Reinvesting</span>
            <span class="v" id="awoo-pet-slot-alarm-proj-upgrade" data-tooltip="If you take each slot upgrade as soon as you can afford it. Each one costs gold now and raises the rate for every action after." data-tooltip-wide>-</span><span class="t"></span>
            <span class="wide awoo-pet-slot-alarm-hint-inline" id="awoo-pet-slot-alarm-proj-upgrade-note"></span>
            <span class="wide awoo-pet-slot-alarm-hint-inline" id="awoo-pet-slot-alarm-proj-note"></span>
          </div>
        </div>

        <div class="awoo-ui-group">
          <div class="awoo-ui-group-label">Alarm<button type="button" class="awoo-ui-group-link"
          ...
          <div class="awoo-pet-slot-alarm-buttons">
            ...
            <button id="awoo-pet-slot-alarm-snooze" class="awoo-ui-btn" type="button">Snooze</button>
        ...
        <div class="awoo-ui-group">
          ...
          <label class="awoo-pet-slot-alarm-check" id="awoo-pet-slot-alarm-notify-row">
            <input id="awoo-pet-slot-alarm-notify" type="checkbox" /><span>Desktop notification when ready</span></label>
          <label class="awoo-pet-slot-alarm-check" id="awoo-pet-slot-alarm-keepawake-row">
          ...
          <label class="awoo-pet-slot-alarm-check" id="awoo-pet-slot-alarm-companion-toggle-row">
            <input id="awoo-pet-slot-alarm-companion-toggle" type="checkbox" /><span>Ring through the Companion when it is running</span></label>
          <div id="awoo-pet-slot-alarm-bg-note" class="awoo-pet-slot-alarm-hint-inline"></div>
        </div>
    ...
    ui.heroActions = content.querySelector('#awoo-pet-slot-alarm-hero-actions');
    ui.heroLabel = content.querySelector('#awoo-pet-slot-alarm-hero-label');
    ui.heroTime = content.querySelector('#awoo-pet-slot-alarm-hero-time');
    ...
    ui.alarmHeadline = content.querySelector('#awoo-pet-slot-alarm-alarm-headline');
    ui.alarmSub = content.querySelector('#awoo-pet-slot-alarm-alarm-sub');
    ...
    ui.detailRateSource = content.querySelector('#awoo-pet-slot-alarm-detail-rate-source');
    ui.detailSynced = content.querySelector('#awoo-pet-slot-alarm-detail-synced');
    ui.headerParty = content.querySelector('#awoo-pet-slot-alarm-header-party');
    ...
    ui.detailGoldSource = content.querySelector('#awoo-pet-slot-alarm-detail-gold-source');
    ...
    ui.readiness = content.querySelector('#awoo-pet-slot-alarm-readiness');
    ...
    windowHandle = Core.createWindow({
      ...
      // `.awoo-window-body`'s scrollHeight vs clientHeight) rather than
  ...
  // (RESTRUCTURE-BRIEF.md D8) gives it a data source that is not this alarm.
  //
  ...
  Core.registerLink({
    ...
    open() {
      ...
      const html = '<script>window.AWOO_LIVE=' + live + ';<' + '/script>' + AWOO_TOOL_PARTY_GOLD_ROI;
